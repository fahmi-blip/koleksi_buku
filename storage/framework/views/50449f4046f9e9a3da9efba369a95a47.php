...
<div class="flex-wrap gap-2 page-header d-flex justify-content-between align-items-center">
    ...
    <a href="<?php echo e(route('home')); ?>" class="btn btn-light">Kembali</a>
</div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-bordered">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $tokos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $toko): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <div class="fw-bold"><?php echo e($toko->barcode); ?></div>
                                    <div class="mt-2 overflow-auto"><?php echo (new \Picqer\Barcode\Renderers\HtmlRenderer())->render((new \Picqer\Barcode\Types\TypeCode128())->getBarcode($toko->barcode)); ?></div>
                                </td>
                                <td><?php echo e($toko->name); ?></td>
                                <td><?php echo e($toko->latitude); ?></td>
                                <td><?php echo e($toko->longitude); ?></td>
                                <td><?php echo e($toko->accuracy); ?></td>
                                <td>
                                    <a href="<?php echo e(route('kunjungan.barcode', $toko)); ?>" target="_blank" class="btn btn-sm btn-primary">Cetak Barcode</a>
                                </td>
                            </tr>
    ...
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('kunjungan.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function fetchTokoByBarcode(barcode) {
        try {
            ...
            const response = await fetch("<?php echo e(route('kunjungan.lookup')); ?>", {
                method: 'POST',
                headers: {
    ...
    async function evaluateVisit(position) {
        ...
        const response = await fetch("<?php echo e(route('kunjungan.check')); ?>", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': csrfToken
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\koleksi-buku\resources\views\pages\kunjungan_toko.blade.php ENDPATH**/ ?>