...
<head>
    ...
    <title><?php echo e(config('app.name', 'Kantin Online')); ?></title>
    ...
    <div class="shell">
        <div class="topbar">
            ...
            <div class="top-actions">
                <a class="chip primary" href="<?php echo e(route('kantin.order')); ?>">Mulai Pesan</a>
                <a class="chip primary" href="<?php echo e(route('kantin.vendor.scan-qr')); ?>">Vendor Scan</a>
            </div>
        </div>
...
</html><?php /**PATH C:\laragon\www\koleksi-buku\resources\views\layouts\kantin.blade.php ENDPATH**/ ?>