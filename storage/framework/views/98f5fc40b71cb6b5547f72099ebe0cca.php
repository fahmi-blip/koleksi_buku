    ...
    <div class="col-lg-7 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form id="formPrint" action="<?php echo e(route('barang.cetakPdf')); ?>" method="POST" target="_blank">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php $__currentLoopData = $ids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="hidden" name="ids[]" value="<?php echo e($id); ?>">
                    ...
                    <div class="mb-4 table-responsive">
                        <table class="table table-bordered table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><span class="badge badge-outline-info"><?php echo e($barang->id_barang); ?></span></td>
                                    <td><?php echo e($barang->nama); ?></td>
                                    <td>Rp <?php echo e(number_format($barang->harga, 0, ',', '.')); ?></td>
                                    <td>
                                        <input type="number" name="quantity[<?php echo e($barang->id_barang); ?>]"
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\koleksi-buku\resources\views\pages\barang\cetak.blade.php ENDPATH**/ ?>