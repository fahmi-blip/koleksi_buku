...
(function () {
    ...
    function lookupPayload(payload) {
        ...
        fetch('<?php echo e(route('qr-scanner.lookup')); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\koleksi-buku\resources\views\pages\qr-scanner.blade.php ENDPATH**/ ?>