			...
			<div class="form-grid">
				<div>
					...
					<select id="vendorSelect" class="field-control">
						...
						<?php $__currentLoopData = $vendorsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<option value="<?php echo e($vendor['idvendor']); ?>"><?php echo e($vendor['nama_vendor']); ?></option>
...
<script>
	document.addEventListener('DOMContentLoaded', () => {
		...
		const vendors = <?php echo json_encode($vendorsData, 15, 512) ?>;
		...
		checkoutButton.addEventListener('click', () => {
			...
			axios.post(<?php echo json_encode(route('kantin.checkout'), 15, 512) ?>, {
...
<?php echo $__env->make('layouts.kantin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\koleksi-buku\resources\views\pages\kantin\order.blade.php ENDPATH**/ ?>