...
<div class="page-header">
    ...
    <a href="<?php echo e(route('barang.create')); ?>" class="btn btn-gradient-primary">+ Tambah Barang</a>
</div>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form id="formCetak" action="<?php echo e(route('barang.formCetak')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" name="ids[]" value="<?php echo e($barang->id_barang); ?>"
                                               class="form-check-input item-check" style="width:18px;height:18px;">
                                    </td>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><label class="badge badge-outline-info"><?php echo e($barang->id_barang); ?></label></td>
                                    <td><?php echo e($barang->nama); ?></td>
                                    <td>Rp <?php echo e(number_format($barang->harga, 0, ',', '.')); ?></td>
                                    <td>
                                        <a href="<?php echo e(route('barang.edit', $barang->id_barang)); ?>"
                                           class="mb-1 btn btn-sm btn-warning">
                                            <i class="mdi mdi-pencil"></i>
                                        </a>
                                        <a href="<?php echo e(route('barcode.index', $barang->id_barang)); ?>"
                                           class="mb-1 btn btn-sm btn-info" target="_blank">
                                            <i class="mdi mdi-barcode"></i>
                                        </a>
                                        <button type="button" class="mb-1 btn btn-sm btn-danger"
                                                onclick="hapusBarang('<?php echo e($barang->id_barang); ?>')">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function handleScannedCode(code) {
        ...
        try {
            const res  = await fetch('<?php echo e(route('barcode-scanner.lookup')); ?>', {
                method:  'POST',
                headers: {
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\koleksi-buku\resources\views\pages\barang.blade.php ENDPATH**/ ?>