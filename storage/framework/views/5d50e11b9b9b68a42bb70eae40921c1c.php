...
<div class="page-header">
    ...
    <div class="btn-group gap-2" role="group" aria-label="Mode tambah customer">
        <a href="<?php echo e(route('customer.index', ['mode' => 'blob'])); ?>" class="btn btn-sm <?php echo e($mode === 'blob' ? 'btn-info' : 'btn-outline-info'); ?>">Tambah Customer 1</a>
        <a href="<?php echo e(route('customer.index', ['mode' => 'file'])); ?>" class="btn btn-sm <?php echo e($mode === 'file' ? 'btn-info' : 'btn-outline-info'); ?>">Tambah Customer 2</a>
    </div>
</div>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e($mode === 'blob' ? route('customer.storeBlob') : route('customer.storeFile')); ?>" id="customerForm">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <button type="button" id="btnOpenCamera" class="btn btn-primary">Ambil Foto</button>
                                <button type="submit" class="btn btn-success">
                                    <?php echo e($mode === 'blob' ? 'Simpan Data (Blob)' : 'Simpan Data (File Path)'); ?>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($customer->foto_link): ?>
                                        <img src="<?php echo e($customer->foto_link); ?>" alt="Foto <?php echo e($customer->nama); ?>" style="width:64px;height:64px;object-fit:cover;border-radius:6px;">
                                    <?php elseif($customer->metode_foto === 'blob' && $customer->foto_blob): ?>
                                        <img src="data:<?php echo e($customer->foto_blob_mime ?? 'image/jpeg'); ?>;base64,<?php echo e(base64_encode($customer->foto_blob)); ?>" alt="Foto <?php echo e($customer->nama); ?>" style="width:64px;height:64px;object-fit:cover;border-radius:6px;">
                                    <?php elseif($customer->metode_foto === 'file' && $customer->foto_path): ?>
                                        <img src="<?php echo e(asset('storage/' . $customer->foto_path)); ?>" alt="Foto <?php echo e($customer->nama); ?>" style="width:64px;height:64px;object-fit:cover;border-radius:6px;">
                                    <?php else: ?>
                                ...
                                <td><?php echo e($customer->provinsi); ?></td>
                                <td><?php echo e($customer->kota); ?></td>
                                <td><?php echo e($customer->kecamatan); ?></td>
                                <td><?php echo e($customer->kodepos_kelurahan); ?></td>
                                <td>
                                    <span class="badge <?php echo e($customer->metode_foto === 'blob' ? 'badge-gradient-info' : 'badge-gradient-primary'); ?>">
                                        <?php echo e(strtoupper($customer->metode_foto)); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\koleksi-buku\resources\views\pages\customer\index.blade.php ENDPATH**/ ?>