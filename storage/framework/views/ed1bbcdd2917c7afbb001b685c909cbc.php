...
unset($__errorArgs, $__bag); ?>" id="email" placeholder="Email" value="<?php echo e(old('email')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="my-2 d-flex justify-content-between align-items-center">
                                    ...
                                    <?php if(Route::has('password.request')): ?>
                                        <a href="<?php echo e(route('password.request')); ?>" class="text-black auth-link">Lupa password?</a>
                                    <?php endif; ?>
                                </div>

                                <div class="mt-4 text-center font-weight-light">
                                    Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="text-primary">Buat Akun</a>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <a href="<?php echo e(route('auth.google')); ?>" class="btn btn-block btn-danger btn-lg font-weight-medium w-100">
...
</html><?php /**PATH C:\laragon\www\koleksi-buku\resources\views\auth\login.blade.php ENDPATH**/ ?>