...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function handleScannedQR(code) {
        try {
            const res = await fetch('<?php echo e(route('kantin.qrcode.lookup')); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.kantin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\koleksi-buku\resources\views\pages\kantin\vendor-scan-qr.blade.php ENDPATH**/ ?>